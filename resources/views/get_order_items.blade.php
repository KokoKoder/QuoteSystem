...
if (isset($_SESSION["order_id"])){
		...
		#get standard items
		$sql="
		SELECT order_items.item_quantity, order_items.Schedule_delivery_date,item_name, suppliers.supplier_name, order_items.id, order_items.status_id, order_items.timestamp, status.status_name, items.item_supplier_id
		FROM order_items 
