...
if(!empty($pay_before)){
$sql = "UPDATE orders_table SET   pay_before='$pay_before', order_date='$order_date', vendor_id='$vendor_id',reference_nb='$reference_nb',note='$order_note' WHERE order_id='$order_id'";
}else{
    $sql = "UPDATE orders_table SET   order_date='$order_date', vendor_id='$vendor_id',reference_nb='$reference_nb',note='$order_note' WHERE order_id='$order_id'";
}
